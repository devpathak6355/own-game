...
var healthBar1, healthLevel1, healthBlock1;
var healthBar2, healthLevel2, healthBlock2;
var block1=0;
var block2=0;
...
function setup() {
  ...
  healthBar1=createSprite(190,100,300,25);
  healthBar1.shapeColor="white";
  healthBar2=createSprite(windowWidth-190,100,300,25);
  healthBar2.shapeColor="white";

  healthLevel1=createSprite(190,100,290,15);
  healthLevel1.shapeColor="red";
  healthLevel2=createSprite(windowWidth-190,100,290,15);
  healthLevel2.shapeColor="red";

  healthBlock1=createSprite(20,100,40,45);
  healthBlock2=createSprite(windowWidth-20,100,40,45);
...
function draw() {
  ...
  if(gameState===PLAY){
    ...
    if(keyDown("N")){
      ...
      if(Player1.isTouching(Player2) && block2===0){
        healthLevel2.x+=0.5;
      }
    }
    ...
    if(keyDown("6")){
      ...
      if(Player2.isTouching(Player1) && block1===0){
        healthLevel1.x-=0.5;
      }
      console.log();
    }
